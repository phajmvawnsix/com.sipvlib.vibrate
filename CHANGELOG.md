...
Odin Inspector is no longer required. VibrateConfig's per-trigger-mode field visibility now uses Alchemy (com.annulusgames.alchemy) instead of Sirenix.OdinInspector.
